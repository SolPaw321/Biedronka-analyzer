...
class BiedronkaReceiptStatusManager:
    ...
    def __default_status(self) -> dict[str, bool]:
        return {
            status_field: False for status_field in self.STAUS_FIELDS
        }
    ...
    def initialize_new_recipts(self) -> None:
    ...
    def normalize_status_fields(self) -> None:
